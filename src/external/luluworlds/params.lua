-- https://github.com/luluworlds/luluworlds-params/blob/cfef39a6de4c21f1140333e8f66252243721c81a/src/params.lua
-- https://github.com/LuaLS/luarocks-build-addon/issues/21
-- this is a manual copy of the luluworlds-params library
